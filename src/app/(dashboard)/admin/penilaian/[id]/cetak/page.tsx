          ...
          <table className="print-table w-full text-[11px]">
            <thead>
              <tr className="bg-gray-100 print:bg-transparent text-center font-bold align-middle">
                ...
                <th className="px-2 py-2">ISTIMEWA<br />90 - 100</th>
                <th className="px-2 py-2">MEMUASKAN<br />75 – 89.99</th>
                <th className="px-2 py-2">CUKUP<br />60 – 74.99</th>
                <th className="px-2 py-2">BURUK<br />40 – 59.99</th>
                <th className="px-2 py-2">BURUK SEKALI<br />&lt; 40</th>
            ...
            <tbody className="align-top">
              {daftarRubrik.map((rubrik, index) => {
                // 🔴 PERBAIKAN: Langsung ambil nilai angkanya secara murni (misal: "98")
                const skorAngka = detailNilai[rubrik.nama_aspek] || "-";
                ...
                return (
                  <tr key={rubrik.id}>
                    ...
                    {/* 🔴 Hasil angka kini akan langsung tercetak di sini */}
